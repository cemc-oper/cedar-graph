...
from cemc_plot_kit.data import LocalDataSource, DataSource, DataLoader
...
def get_plot_module(plot_type: str, base_module_name: str = "cemc_plot_kit.plots") -> types.ModuleType:
    """
    根据绘图类型返回绘图模块
