"""Test rain_24h plot with mock data."""
...
def test_rain_24h_cn(mock_data_source, start_time, forecast_time, system_name, sample_step, output_dir):
    """Test 24h rain plot for China domain."""
    ...
    output_path = Path(output_dir, "rain_24h.CN.png")
